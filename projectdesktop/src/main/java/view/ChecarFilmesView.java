 ...
 * @author jonas
 */
public class ChecarFilmesView extends javax.swing.JFrame {

    /**
     * Creates new form ChecarFilmesView
     */
    public ChecarFilmesView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Filmes cadastrados");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChecarFilmesView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
