 ...
 * @author jonas
 */
public class RemoverAnimesView extends javax.swing.JFrame {

    /**
     * Creates new form RemoverAnimesView
     */
    public RemoverAnimesView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Remoção de animes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoverAnimesView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
